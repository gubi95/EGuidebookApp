...
public class CaptureSpotImagePreview extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public CaptureSpotImagePreview(Activity activity, int cameraId, LayoutMode mode, FancyButton objButtonCaptureImage) {
        ...
        mPictureCallback = new Camera.PictureCallback() {
            public void onPictureTaken(byte[] data, Camera camera) {
                try {
                    try {
                        PLHelpers.setCreateSpotCurrentImage(data);
                    }
                    catch (Exception ex) {
                        ex.printStackTrace();
                    }
        ...
        objButtonCaptureImage.setOnClickListener(new OnClickListener() {
            @Override
